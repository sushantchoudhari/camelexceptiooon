...
public class CamelErrorHandlerTest extends CamelTestSupport {
    ...
    public class prcessss implements Processor{

		@Override
		public void process(Exchange exchange) throws Exception {
			// TODO Auto-generated method stub
			LOG.info("FAILURE ENDPOINT: sushant {}", exchange.getProperty(Exchange.FAILURE_ENDPOINT, String.class));
        	LOG.info("FAILURE MESSAGE: sushant {}", exchange.getProperty(Exchange.EXCEPTION_CAUGHT, Exception.class).getMessage());
		}
